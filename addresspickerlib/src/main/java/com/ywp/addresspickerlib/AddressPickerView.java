...
public class AddressPickerView extends RelativeLayout implements View.OnClickListener {
    ...
    private int defaultSelectedColor = Color.parseColor("#ea3d00");
    // recyclerView 未选中Item 的颜色
    private int defaultUnSelectedColor = Color.parseColor("#262626");
    // 确定字体不可以点击时候的颜色
    private int defaultSureUnClickColor = Color.parseColor("#ea3d00");
    // 确定字体可以点击时候的颜色
    private int defaultSureCanClickColor = Color.parseColor("#ea3d00");
    ...
    private String defaultProvince = "省市"; //显示在上面tab中的省份
    private String defaultCity = "城市"; //显示在上面tab中的城市
    private String defaultDistrict = "县区"; //显示在上面tab中的区县
